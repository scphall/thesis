...
This single process is suppressed by the \ckm matrix element \V{ub}, which is the element with the
%The branching fraction measurement made in this analysis is sensitive to \np effects contributing
%to the decay \btodsphi because it can only propagate via an annihilation type diagram in the \sm.
%This diagram contains the \V{ub}, which has the largest uncertainties in the \ckm matrix and there are historic tensions
largest uncertainties in the \ckm matrix.
There are there also are historic tensions
between measurements of \V{ub} made using inclusive an exclusive modes.
...
% CONCLUSIONS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In conclusion, the \sm continues in its resilience.
