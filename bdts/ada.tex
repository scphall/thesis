...
\begin{equation}
  ...
  \label{eq:ada:wt}
\end{equation}
where is $c$ based on the classification of the event in the previous tree, it is determined to be
\begin{align}
...
%zero.
Weights are then renormalized such that they sum to unity.
