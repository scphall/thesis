...
The important terms for this are \Lag{\it q}, \deleted{(}\Lag{Higgs}, and \Lag{Yuk} from \Eq{eq:th:lag}.
...
\end{align}
and the \added{charged} lepton masses
\begin{equation}
...
basis, in which the matrices $m^{u,d}$ are diagonal, this is done
}{
  Thus far, the flavour basis has been used, but it is now more convenient to change to the mass
