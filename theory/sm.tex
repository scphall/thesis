...
Violation of \CP and flavour in the \sm is in the \ckm, which emerges
...
--- because $\psi_L$ and $\psi_R$ have different $U_Y(1)$ charges ---
and so cannot be added to \Lag{SM} without destroying the gauge invariance without destroying the
gauge invariance.
...
\begin{equation}
  ...
  \label{eq:th:lagyukq}
\end{equation}
where $\widetilde\Phi_i = \varepsilon_{ij}\Phi_k$ and there is an implicit sum over the generations
$i$ and $j$.
...
The \NC part of \Lag{\it q} characterizes interactions between quarks and the neutral electroweak
