...
%are organised into pairs forming three generations.
...
Therefore, using \Eq{eq:diracmass} to give masses to fermions would break gauge invariance.
...
\end{align}
%\replaced{
Thus far all calculations have been in the flavour basis, but it is now more convenient to change
to the mass basis in which the matrices $m^{u,d}$ are diagonal, this is done
%}{
