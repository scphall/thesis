...
\squark, \tquark and \bquark); and six leptons: the electron, muon, tau ($e$, $\mu$, $\tau$), and
...
as a direct consequence of the Higgs mechanism breaking the local electroweak symmetry.
...
vector boson.
In the \CC part of \Lag{\it q}; which transforms as:
\begin{align}
  \Lag{\it q}^\mathrm{CC}
  &= i\frac{g}{2}\gamma^\mu
