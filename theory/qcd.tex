...
Confinement describes the behaviour of the strong force over long distances ($\sim1\fm$)
...
An important supposition is that that the short-distance, process dependent, QCD effects are
...
calculation of $B$ mesons decaying into hadron (semi-hadronic) final states.
