...
Currently, there is no explaination for the discrepancy between inclusive and exclusive
measurements of \V{ub}.
...
Certainly, both approaches are well established, but rely on non-peturbative \QCD calculations.
...
The decay \btodsphi is also an annihilation-type decay which includes the parameter \V{ub}; an
analysis of this decay is described in \Chap{ch:dsphi}.
