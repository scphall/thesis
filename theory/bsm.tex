...
\sm.
\replaced{The flavour-change}{Oscillations} of neutrinos in flavour space mean that they must have
...
$R$-parity is \deleted{is} defined by the baryon number, lepton number, and spin of a particle; and the
...
After \SUSY is broken there are five Higgs physical scalar \replaced{particle;}{particles,} two are \CP-even ($h^0$,
...
Particle dynamics can be \replaced{affected}{effected} by massive \np particles, like those in \SUSY, in lower order
...
These rare, and \deleted{low} background\added{-suppressed} processes provide ideal environments in which to search for \bsm
...
Of all the fundamental parameters in the \ckm matrix, \V{ub} is \replaced{known}{know} to the lowest precision, and
...
\end{equation}
where \replaced{
  $\theta$ is a phase, and $g$ is a constant
}{
$\theta$ and $g$ are constants}~\cite{Peccei:2006as}.
