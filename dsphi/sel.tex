...
The bagging boosting technique used --- as described in \Sec{sec:bdt:bag} --- gives
a response in the range $0<\mathrm{BDT}<1$.
Therefore it is possible to, naturally, cut on the product of the two \BDT responses,
...
selection.
This is demonstrated in \Fig{fig:dsphi:bdtprod}.
...
\begin{figure}
  \begin{center}
      ...
      for the decay \btodsd]
    {
      ...
      $\bdt_{\Ds}\times\bdt_{\Dz}>0.01$, 0.04, 0.10, 0.20, 0.30, 0.40, and 0.05.
    }
