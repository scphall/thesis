...
For example, in a model with two Higgs doublets (2HDM) --- such as SUSY --- the decay \btodsphi
...
\begin{equation}
  \acp = \frac{\Gamma(\Bbar\!\to\xbar{f}) - \Gamma(\Bbar\!\to f)}
  {\Gamma(\Bbar\!\to\xbar{f}) + \Gamma(\Bbar\!\to f)}
\end{equation}
