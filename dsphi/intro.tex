...
shown in \Fig{fig:dsphi:feyn}, where
...
%known, th
%Beyond uncertainties in \V{ub}, predictions for the branching fraction $\BF(\btodsphi)$
%are made difficult by \QCD, particularly be
%Despite the relatively simple effective Hamiltonian, \QCD limits the accuracy of calculating
%the branching fraction $\BF\big(\btodsphi\big)$.
...
%non-factorizable, because the hadronization component is not separable from the the short-range,
%iteration, process.
%There are also inherent uncertainties in the hadronic form-factors that describe the hadronization
%process of the final state quarks.

Despite the theoretical uncertainties, enhancements in the value of
