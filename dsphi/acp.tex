...
Values of $N$ are determined by defining a signal region, which
extends $2\stdev$ either side of the mean \Bp mass in region \rA, where $\mu=5283\mev$ and
$\sigma=13.2\mev$.
In this region, the number of \Bp and \Bm candidates are $N(\btodsphi)=3$ and
$N(\decay{\Bm}{\Dsm\phi})=3$.
...
which gives a $1\stdev$ interval $\in[-0.41, 0.41]$.
...
\replaced{
  Since in 2011 approximately $30\%$ more data was recorded in one polarity than the
other, there could conceivably be an effect.
}{
Considering that the 2011 dataset had approximately $30\pc$ more data in one polarity than the
other, there could conceivably be an effect.
}
