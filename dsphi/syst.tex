...
%sel
%geometry desccribed well
%and reco
%discrepancy in IP resolution, but very loose cut, not an issue
%1\% to account for imperfect modelling in simulation
%BDT eff from data, so not a problem
%
%Trig
