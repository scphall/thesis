...
invariant mass within $12\mev$, which is three times the resolution of the \phii, of $m_\phi^\pdg$
is applied.
...
$30\mev$ of the nominal \Dz mass in the $\Kp\pi^-_\mu$ spectrum are vetoed. \bam{PLOT.}
...
\subsubsection{Optimization of particle identification criteria and multivariate classifier}
