...
\begin{table}
  ...
  \end{center}
  \caption{
    Stripping selection criteria applied in the stripping.
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.48\textwidth]{hhhmisid_pre}
    \includegraphics[width=0.48\textwidth]{hhhmisid_post}
