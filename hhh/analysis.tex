...
algorithm~\cite{AdaBoost}, which is described in detail in \Sect{sec:bdt:ada}.
This BDT was trained using the variables listed in \Tab{hhh:tab:bdtvars}, where the signal and
background samples were taken from data.
The sample of data used as the signal-proxy wa w

The signal-proxy used taken from  the of \btojpsikpipi
