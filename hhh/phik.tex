...
%That being said, the shape of distributions at the edges can be explained
...
%The normalisation channel has a large relative uncertainty on its measured branching fraction
%$\BF\big(\btojpsiphik\big)=\big(5.2\pm1.7\big)\e{-5}$~\cite{PDG2012}.
%With
...
\btokpipimumu, and are summarised in \Table{tab:phik:syst}.
