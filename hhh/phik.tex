...
as shown in \Fig{fig:hhh:phikeff}.
...
\begin{table}
  ...
  \begin{tabular}{lc}\toprule
    Source & $[\times10^{-8}]$
    \\\midrule
    Norm.~channel \BF      &   2.688        \\  % x10e-8
    \littlerule
    Tracking eff.          &   0.057        \\  % x10e-8
    Reweighting            &   0.020        \\  % x10e-8
    PID eff.               &   0.047        \\  % x10e-8
    {\tt IsMuon} and {\tt PIDmu} eff. &   0.013     \\  % x10e-8
    Rel.~eff.              &   0.065        \\  % x10e-8
    Bkg.~mass model        &   0.245        \\  % x10e-8
    Sig.~mass model        &   0.128        \\  % x10e-8
