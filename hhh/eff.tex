...
\added{caused by the modelling of hadronization in \pythia and are} illustrated in
\Fig{fig:hhh:ntracks}.
\added{The source of the difference between data and simulation is the hadronization process which
