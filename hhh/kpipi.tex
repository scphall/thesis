...
%This was chosen for the normalisation channel over the decay \btojpsikpipi because it has a
...
%is the yield of the normalisation channel.
%Total deficiencies for reconstruction and selection are denoted by \eff{sig} and \eff{norm} for the
%signal and normalisation channels respectively.


The yield  of the normalisation channel is extracted from an unbinned extended maximum likelihood
