...
\end{align}
The operator \Op{7} describes the FCNC via a photonic penguin, and \Op{8} is the $Z$ penguin
operator.
Operator \Op{10} corresponds to the box diagram for with mediating \Wp bosons.
...
\begin{figure}
  \begin{center}
    ...
    {\small
      ...
      the SM via operators \Op7 or \Op9.
    }
    \label{fig:hhh:feyn}
  \end{center}
\end{figure}
