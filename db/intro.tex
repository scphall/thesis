...
A fully frequentist method is applied to the dimuon distribution of \btokstrmumu candidates,
...
Particles introduced by \SUSY include the super-goldstino (or sgolditinos), which is the scalar
super-partner to the \sm Goldstone bosons arising when \SUSY breaks.
If the scale at which \SUSY breaks, $\Lambda_\mathrm{QCD}$, is high enough then the
