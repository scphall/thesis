...
} \added{as published in Ref.~\cite{LHCb-PAPER-2015-036}, although some of the results in this
thesis are a result of individual work}.
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{mchi_theta_dm_labels_edit}
    \caption[Parameter space for a model including an inflaton]
    {
      \added{
      Figure taken from Refs.~\protect\cite{Bezrukov:2014nza,Bezrukov:2013fca}, showing the allowed
      and excluded
      ...
      (red) an experiment my the CHARM collaboration~\protect\cite{Bergsma:1985qz};
      ...
      no reheating.
      Lines indicate specific lifetime contours for this model.
    }
    }
