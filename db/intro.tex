...
\begin{table}
  \caption{\small
    ...
    $a$ is axion field,
    $f_a$ is scale at which PQ global U(1) symmetry is spontaneously borken,
    $G_{\mu\nu}$ is the gluon field strength tensor,
    $S$ is a dark scalr field with coupling strengths $\mu$ and $\lambda$ to the Higgs field, $H$,
