...
dubbing the \sm Goldstone fermions \emph{goldstinos}, the corresponding \SUSY versions are scalar
\emph{sgoldstinos}.
After electroweak symmetry breaking, these sgoldstinos interact with \sm fermions via Yukawa-like
interactions, but suppressed by the \SUSY breaking parameter, $F$,~\cite{Alekhin:2015byh};
where $F$ is approximately related to the scale of \SUSY breaking as
