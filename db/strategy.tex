...
In order to obtain a trials factor, 10 million toy datassets are generated, and the minimum
$p$-value is plotted in a cumulative distruibution, such that the $y$ axis is the fraction of toy
...
for each \lifetime there is a relattionship between the number of signal events in the prompt and
displaced regions
