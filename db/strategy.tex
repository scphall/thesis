...
\added{The \emph{look-elsewhere effect} is the name for the phenomenon whereby a statistically
significant result appears by chance as a consequence of making a number of measurements.
...
All known \ccbar resonances that decay to a pair of muons with masses above the $\psi(3770)$ are
relatively wide, with $\Gamma\sim 70\mev$, and are therefore fall into the intermediate category of
widths described above.
Since there are many resonances in this region the background shape is more uncertain, and so the
size of the sidebands is reduced to $x=1$.
