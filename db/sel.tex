...
\begin{table}[ht!]
  ...
  {
    Selection criteria applied to signal candidates during the \lhcb stripping phase.
...
topological and \pid quantities; all these cuts are summarised in \Tab{tab:db:presel}.
...
%In \Sect{sec:strategy} it is briefly mentioned that the observed signal yields will be normalised
