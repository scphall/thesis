...
%Assuming that the efficiencies vary continuously, it is possible to parameters efficiencies using
%spline interpolation.
%This is done by parameterising the way that efficiency varies with mass and lifetime.
...
%The normalisation channel is restricted in \qsq region, between 1.1 and $6.0\gevgev$.
...
and this simple parameterisation, as shown in \Fig{fig:eff:fits}.
