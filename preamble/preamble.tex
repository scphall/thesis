...
\usepackage[a4paper,top=2.5cm,bottom=2.4cm,left=2.8cm,right=2.2cm,asymmetric]{geometry}
\headheight=14pt
...
\usepackage[justification=justified,singlelinecheck=false]{caption} %format=hang
\usepackage[labelfont=bf]{caption}
\renewcommand{\captionfont}{\small\onehalfspacing}
...
%\usepackage[draft]{hyperref}    % Hyperlinks in references
...
%\definecolor{linkblue}{rgb}{0.0, 0.28, 0.67}
\hypersetup{
...
\newlength{\abstractpagewidth}
\setlength{\abstractpagewidth}{0.85\textwidth}
