...
\def\thetaopen{\ensuremath{\theta_\mathrm{open}}\xspace}
...
\def\kpipiss{{\ensuremath{\Km\pip\pip}}\xspace}
\def\pkpi{{\ensuremath{\proton\Km\pip}}\xspace}
...
\def\bdt{{\ensuremath{\mathrm{BDT}}}\xspace}
\def\kpipimumu{{\ensuremath{\Kp\pip\pim\mup\mun}}\xspace}
...
\def\btojpsikstr{\mbox{\decay{\Bd}{\jpsi\Kstarz}}\xspace}
...
\newcommand\Ref[1]{Ref.~\cite{#1}\xspace}
...
\def\acp{\ensuremath{\mathcal{A}_{C\!P}}\xspace}
...
\def\tis{\gls{TIS}\xspace}
\def\tos{\gls{TOS}\xspace}
\def\tistos{\ensuremath{\mathtt{TISTOS}}\xspace}
%\def\approx{\ensuremath{\sim\!}}
\def\approx{\ensuremath{\hspace{0.1em}\sim}}
\def\nlto{\raisebox{3pt}{$\drsh$}\xspace}
\newcommand\plane[2]{$#1#2$\nobreakdash-plane}
\newcommand\mass[1]{\ensuremath{m_{#1}}\xspace}
\newcommand\lifetime[1]{\ensuremath{\tau_{#1}}\xspace}
\newcommand\misid[2]{\ensuremath{#1_{#2}}\xspace}
\def\like{\ensuremath{\mathcal{L}}\xspace}

\def\sigmam{\ensuremath{\sigma_m}\xspace}
\def\sigmat{\ensuremath{\sigma_\tau}\xspace}

\def\darkgamma{\ensuremath{A^\prime}\xspace}
\def\ndf{\ensuremath{\mathrm{ndf}}\xspace}
\def\FDT{\ensuremath{F\!D_T}\xspace}
...
\newcolumntype{R}[1]{>{\raggedleft\let\newline\\\arraybackslash\hspace{0pt}}m{#1}}
  %\begin{tabular}{lL{0.28\textwidth}C{1em}R{0.15\textwidth}L{\widthof{MeV}}}\toprule
\newenvironment{tabularcuts}{
  \begin{tabular}{llC{1em}R{0.15\textwidth}L{\widthof{MeV}}}\toprule
    Candidate & \multicolumn{3}{c}{Selection criterion}
    \\ \midrule
  }{
  \end{tabular}
}

\newcommand\ProbNN[1]{\ensuremath{\mathcal{P}_{#1}}\xspace}
