...
%\def\intr   {IT\xspace}
\def\intr   {\gls{IT}\xspace}
%\def\st     {ST\xspace}
\def\st     {\gls{ST}\xspace}
%\def\ot     {OT\xspace}
\def\ot     {\gls{OT}\xspace}
\def\Tone   {T1\xspace}
\def\Ttwo   {T2\xspace}
...
\def\ecs    {ECS\xspace}
%\def\lone   {L0\xspace}
\def\lone   {\gls{L0}\xspace}
%\def\hlt    {HLT\xspace}
\def\hltone {HLT1\xspace}
\def\hlttwo {HLT2\xspace}
\def\hlt    {\gls{HLTLabel}\xspace}
%\def\hlt    {\gls{HLT1}\xspace}
%\def\hlt    {\gls{HLT2}\xspace}
...
\def\dllxy     {\ensuremath{\mathrm{DLL}_{XY}}\xspace}
