...
\newacronym{C}{\ensuremath{C}}{Charge conjugation}
...
\newacronym{DOCA}{DOCA}{Distance of Closest Approach}
...
\newacronym{SPDLabel}{SPD}{Scintillating Pad Detector}
...
\newacronym{TOS}{\ensuremath{\mathtt{TOS}}\xspace}{Trigger On Signal}
\newacronym{TTLabel}{TT}{Tracker Turicensis}
\newacronym{T}{\ensuremath{T}}{Time reversal}
...
\newacronym{DLL}{DLL}{Delta Log Likelihood}
\newacronym{PQ}{PQ}{Peccei–Quinn}
...
\def\TOS {\gls{TOS}\xspace}
\def\TIS {\gls{TIS}\xspace}
\def\DOCA {\gls{DOCA}\xspace}
