...
The \spd is positioned just downstream of the first muon station, M1,
which in turn is immediately downstream of \richtwo
...
% trigger does not need full shower containment, so optimised for space
